            ...
            pages: [
              Container(
                ...
                child: Column(
                  children: [
                    Image.asset(
                      'assets/images/onboarding_splash_screen/onboarding1.png',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Image.asset(
                      'assets/images/onboarding_splash_screen/onboarding2.png',
                      height: size.height * .5,
                      //width: size.width * .5,
                    ),
                    const Text(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Image.asset(
                      'assets/images/onboarding_splash_screen/onboarding3.png',
                      height: size.height * .5,
                      //width: size.width * .5,
                    ),
                    const Text(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Image.asset(
                      'assets/images/onboarding_splash_screen/onboarding4.png',
                      height: size.height * .5,
                      //width: size.width * .5,
                    ),
                    const Text(
